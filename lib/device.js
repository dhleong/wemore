        ...
        request({
          ...
          , headers: {
            ...
            if (err || response.statusCode >= 300) {
                return reject(err || new Error('Invalid Request (' + response.statusMessage + ')'));
            }
...
WemoDevice.prototype.resolve = function() {
    ...
    request(this.location, function(error, response) {
        ...
        parseXml(response.body, XML_OPTIONS, function(err, json) {
...
WemoDevice.prototype.getBinaryState = function() {
    ...
    return soapRequest(this.host, 'GetBinaryState', '').then(function(resp) {
        return Q.nfcall(parseXml, XML_OPTIONS, resp.body)
        .then(function(json) {
